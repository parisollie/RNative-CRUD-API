...
const NuevoCliente = ({navigation, route}) => {
    ...
    const guardarCliente = async () => {
        ...
        // //Vid 268, Si estamos editando o creando un nuevo cliente
        ...
        //Vid 262,cambiar a true para traernos el nuevo cliente
...
//     //Vid 267 detectar si estamos editando o no
//     useEffect(() => {
//         if(route.params.cliente) {
//             //lleando los campos 
...
//         } else {
//             //Vid 257,guardar el cliente en la API por primera vez.
//             try {
//                 //Vis 257
//                 if(Platform.OS === 'ios') {
//                     await axios.post('http://localhost:3000/clientes', cliente)
//                 } else {
//                     await axios.post('http://192.168.0.11:3000/clientes', cliente);
//                 }
//             } catch (error) {
//                 console.log(error);
//             }
...
//         //Vid 258,redireccionar
//         navigation.navigate('Inicio');

//         //Vid 258,limpiar el form (opcional)
//         guardarNombre('');
//         guardarTelefono('');
//         guardarCorreo('');
//         guardarEmpresa('');
...
//                 placeholder="Juan"
//                 onChangeText={ texto => guardarNombre(texto) }
//                 //Vid 253, les ponemos el nombre que le corresponde a cada uno.
//                 value={nombre}
//                 style={styles.input}
//             />
//             <TextInput
